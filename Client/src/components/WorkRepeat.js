...
import RepeatWork from "../services/PREMIUM/RepeatWorkService";
  ...
  const WorkRepeat = ({ workItem, reload, navigation }) => {
      ...
      <View>
        <Swipeable renderRightActions={renderRightActionsForWork}>
          ...
          >
            ...
            <TouchableOpacity onPress={handleRepeat}><Fontisto name="spinner-refresh" size={24} color="gray" /></TouchableOpacity>
