const uri =
  ...
  const getAllSoundDonePrenium = async () => {
    try {
  ...
  const updateSoundDone = async (id, nameSoundDone, url) => {
    ...
    export {getAllSoundDonePrenium, getAllSoundDoneDelete, addSoundDone, updateSoundDone, markDeleteSoundDone, deleteSoundDone,recoverSoundDone}