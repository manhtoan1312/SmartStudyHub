  ...
  return (
    <ScrollView style={s`flex-1 bg-gray`}>
      <View style={s` flex-1 bg-white justify-center items-center my-2`}>
        <Feather style={s`absolute left-1`} size={24} name="x" onPress={() => navigation.goBack()}/>
      ...
      <View style={s`flex-1 flex-row py-4 pl-4 bg-white`}>
        ...
        <View style={s`flex flex-col px-3`}>
          <View style={s`flex flex-row items-center`}>
            <View style={s`mr-2`}>
              <Text style={s` text-lg font-medium`}>Đăng Nhập</Text>
            </View>
            <Text style={s` text-lg font-medium`}>|</Text>
            <View style={s`ml-2`}>
              <Text style={s`text-lg font-medium`}>Đăng Ký</Text>
            </View>
          </View>
      ...
      <View style={s`flex flex-row justify-between px-2 mt-6 bg-white py-4`}>
        ...
        <AntDesign style={s`text-lg font-medium`} name="right"  onPress={() => navigation.navigate('Project')}/>
      </View>
      ...
      <View style={s`flex flex-col px-2 mt-6 bg-white py-2`}>
        ...
        <View style={s`flex flex-row justify-between py-2`}>
          <Text style={s` text-lg font-medium`}>Tiếng động giúp tập trung</Text>
          <View style={s`flex flex-row`}>
